...
class wifi_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "wifi_tx")
        ...
        self.PlutoID = PlutoID = "usb:2.5.5"
        ...
        self._interval_range = qtgui.Range(0, 1000, 1, 300, 200)
        ...
        self._tx_gain_range = qtgui.Range(0, 70, 1, 0, 200)
        ...
        self.blocks_message_strobe_0_0_0 = blocks.message_strobe(pmt.intern("yyyyyyyyyy"), interval)


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0_0_0, 'strobe'), (self.ieee802_11_mac_0, 'app in'))
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.network_udp_sink_0, 0))
