...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.buffer_size = buffer_size = 8192*9
        ...
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_gr_complex, 1, '127.0.0.1', 40860, 0, 8192*9, False)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.uhd_usrp_source_0, 0), (self.network_udp_sink_0, 0))
