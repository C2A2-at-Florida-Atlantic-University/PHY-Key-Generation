...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "wifi_rx")
        ...
        self.gain = gain = 50
        self.freq_test = freq_test = 3100000000
        self.freq = freq = 2412000000
        self.chan_est = chan_est = 0
        self.PlutoID = PlutoID = "usb:2.6.5"
        ...
        self.pdu_pdu_to_tagged_stream_0_0_0_0 = pdu.pdu_to_tagged_stream(gr.types.complex_t, 'packet_len')
        self.pdu_pdu_to_tagged_stream_0_0_0 = pdu.pdu_to_tagged_stream(gr.types.complex_t, 'packet_len')
        ...
        self._gain_range = qtgui.Range(0, 80, 1, 50, 200)
        ...
        self.msg_connect((self.ieee802_11_frame_equalizer_0, 'pilots'), (self.pdu_pdu_to_tagged_stream_0_0, 'pdus'))
        self.msg_connect((self.ieee802_11_frame_equalizer_0, 'csi'), (self.pdu_pdu_to_tagged_stream_0_0_0, 'pdus'))
        self.msg_connect((self.ieee802_11_frame_equalizer_0, 'chan_est_samples'), (self.pdu_pdu_to_tagged_stream_0_0_0_0, 'pdus'))
        ...
        self.connect((self.ieee802_11_sync_long_0, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.ieee802_11_sync_short_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ieee802_11_sync_short_0, 0), (self.ieee802_11_sync_long_0, 0))
        self.connect((self.network_udp_source_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.network_udp_source_0, 0), (self.blocks_delay_0_0, 0))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.pdu_pdu_to_tagged_stream_0_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.pdu_pdu_to_tagged_stream_0_0_0_0, 0), (self.qtgui_time_sink_x_1_0_0, 0))
    ...
    def get_freq_test(self):
        return self.freq_test

    def set_freq_test(self, freq_test):
    ...
    def get_PlutoID(self):
        return self.PlutoID

    def set_PlutoID(self, PlutoID):
        self.PlutoID = PlutoID
